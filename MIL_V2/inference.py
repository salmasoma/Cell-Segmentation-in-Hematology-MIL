...
def inference_mil(patches_csv):
    ...
    graph_net.load_state_dict(torch.load("/home/salma.hassan/AI702/Project/MUSTANG-main/results/graph_Patches_bags_of_5_42_5_0.7_0.0001/checkpoints/checkpoint_101.pth"), strict=True)
